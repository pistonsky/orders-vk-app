...
<script type="text/template" id="tab-menu-template">
     <% _.each(menu, function(e, i, l){
          print('<div class="menu-item" style="background-image:url(' + e.picture + ')" title="' + e.description + '"><div class="info"><span class="price">'+ e.price.split('.')[0] + '&#3647;</span><p class="title">' + e.title + '</p></div></div>');
     }) %>
