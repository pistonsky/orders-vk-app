...
<script type="text/template" id="tab-menu-template">
     <% _.each(menu, function(e, i, l){
          print('<div class="menu-item" data-count=0 data-id='+e.id+' data-price='+e.price+' style="background-image:url(' + e.picture + ')" title="' + e.description + '"><div class="counter"></div><div class="info"><span class="price">'+ e.price.split('.')[0] + '&#3647;</span><p class="title">' + e.title + '</p><p class="description">' + e.description + '</p></div></div>');
     }) %>
